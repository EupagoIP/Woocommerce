  ...
  */
  ...
  public function getReferenciaMB($order_id, $valor, $per_dup = 0, $deadline = null) {
    if (extension_loaded('soap')) {
      ...
      curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://' . get_option('eupago_endpoint') . '.eupago.pt/clientes/rest_api/multibanco/create',
  ...
  public function getReferenciaPS($order_id, $valor) {
    if (extension_loaded('soap')) {
      ...
      curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://' . get_option('eupago_endpoint') . '.eupago.pt/clientes/rest_api/payshop/create',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
  ...
  public function getReferenciaMBW($order_id, $valor, $telefone) {
    if (extension_loaded('soap')) {
      ...
      curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://' . get_option('eupago_endpoint') . '.eupago.pt/clientes/rest_api/mbway/create',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
  ...
  public function pedidoPF($order, $valor, $return_url, $comment) {
    if (extension_loaded('soap')) {
      ...
      curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://' . get_option('eupago_endpoint') . '.eupago.pt/clientes/rest_api/paysafecard/create',
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
