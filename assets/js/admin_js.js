jQuery( document ).ready(function($) {
    ...
    $('.eupago-refund-request').on('click', function() {
        ...
        $.get( site_url + "/wp-content/plugins/eupago-gateway-for-woocommerce/includes/functions/refund-request.php", {
            refund_order: refund_order, refund_name: refund_name, refund_iban: refund_iban, refund_bic: refund_bic, refund_amount: refund_amount, refund_reason: refund_reason },function(response) {
