...
if ($method == 'eupago_multibanco') :
  ...
  echo "\n";
  _e('Entity', 'eupago-gateway-for-woocommerce'); echo ': '; echo $entidade;
  echo "\n";
  _e('Reference', 'eupago-gateway-for-woocommerce'); echo ': '; echo chunk_split($referencia, 3, ' ');
  echo "\n";
  _e('Value', 'eupago-gateway-for-woocommerce'); echo ': '; echo $order_total; echo '&euro;';
  echo "\n";
